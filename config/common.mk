...
# Backup Transport
PRODUCT_PACKAGE_OVERLAYS += $(SRC_NOSP_DIR)/overlay/common
...
$(call inherit-product, $(SRC_NOSP_DIR)/config/tools.mk)

# LatinIME english dictionary
$(call inherit-product, $(SRC_NOSP_DIR)/config/dictionaries/english.mk)
...
ifeq ($(NIGHTLY_BUILD),true)
  ...
  ROM_VERSION := $(TARGET_PRODUCT)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_EXTRA)-$(shell date +%Y.%m.%d)$(APPEND_ZIP)
endif
